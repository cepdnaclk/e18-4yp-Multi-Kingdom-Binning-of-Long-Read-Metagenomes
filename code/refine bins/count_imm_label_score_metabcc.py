...
def get_misbinned(initial_tool_results, output_folder):
    ...
    # ASSUMED THAT EDGES FILE ALREADY CREATED
    print("Loading files...")
    ...
    np.save(output_folder + 'mis_binned_imm.npy', list(mis_binned))
    np.save(output_folder + 'new_clusters_imm.npy', list(new_clusters))
    return new_clusters
